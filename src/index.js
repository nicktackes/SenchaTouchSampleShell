...
Ext.ux.UniversalUI = Ext.extend(Ext.Panel, {
    ...
    items: [{
        cls: 'launchscreen',
        html: '<div><img src="resources/img/sencha.png" width="210" height="291" /><h1>Sencha Touch Extensions</h1><p><br /><br /><span>Sencha Touch (' + Ext.version +')</span></p></div>'
    }],
    backText: 'Back',
    ...
    initComponent : function() {
        ...
        if (!Ext.is.Phone) {
            this.navigationPanel.setWidth(270);
        }
...
sink.Main = {
    init : function() {
        ...
        this.ui = new Ext.ux.UniversalUI({
            title: Ext.is.Phone ? 'Extensions' : 'Sencha Touch Extensions',
